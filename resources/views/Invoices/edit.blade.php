...
@section('content')
    <div class="panelp panelp-default">
        ...
        <div class="panelp-body">
            ...
            {{ Html::ul($errors->all()) }}
            <form class="form-horizontal" method="POST" id="add_content" role="form" action="{{ route('Invoices.updateReoccuringPayment',$invoice->id)}}">
                {{ csrf_field() }}            
                ...
                <div class="form-group" style="margin-top:10px;">                
                    ...
                    <div class="col-lg-offset-1">
                        <button type="button" onclick="submitMe()" style="width:130px;" class="btn btn-primary btn-sm save-btn">Paywith Paypal</button>                    
                    </div>
                </div>
            {!! Form::close() !!}
        </div>
