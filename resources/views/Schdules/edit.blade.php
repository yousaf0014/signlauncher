...
@section('content')
    <div class="panelp panelp-default">
        <div class="panelp-heading">
            <div class="tbl">
                    <div class="tbl-row">
                        <div class="tbl-cell">
                            <div class="pull-left">
                                <h3>Edit Schdules({{$channel->name}})</h3>
                            </div>
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li><a href="{{url('/Schdules')}}">Schdules({{$channel->id}})</a></li>
        ...
        <div class="panelp-body">
            ...
            {{ Html::ul($errors->all()) }}
            {!! Form::model($schdule, array('url' => array('/Schdules/update', $schdule->id),'id'=>'add_content','name'=>'add_content','class'=>'form-horizontal', 'method' => 'PUT')) !!}
                ...
                <div class="form-group">
                    <label class="col-lg-2 control-label" style="padding-top: 1%; font-weight: bold;">Duration
                        <input type="checkbox" id="checkField" {{!empty($schdule->duration) ? 'checked="checked"':''}} onclick="enableInput()" value="1"><small>Enable</small>
                    </label>
                    <div class="col-lg-10">
                ...
                <div class="form-group" style="margin-top:10px;">                
                    <div class="col-lg-offset-1 col-lg-2" >
                        <a class="pull-right btn btn-danger" href="{{url('/Schdules',$channel->id)}}">
