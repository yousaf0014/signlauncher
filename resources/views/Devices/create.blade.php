...
@section('content')
    <div class="panelp panelp-default">
        ...
        <div class="panelp-body">
            ...
            {{ Html::ul($errors->all()) }}
            {!! Form::open(array('url' => 'Devices','id'=>'add_content','name'=>'add_content','class'=>'form-horizontal')) !!}
                <div class="form-group">
                    <label class="col-lg-2 control-label" style="padding-top: 1%;font-weight: bold;">Device ID</label>
                    <div class="col-lg-10">
                ...
                <div class="form-group">
                    <label class="col-lg-2 control-label" style="padding-top: 1%;font-weight: bold;">Channel</label>
                    <div class="col-lg-10">
                ...
                <div class="form-group">
                    <label for="inputName" class="col-lg-2 control-label" style="padding-top: 1%;font-weight: bold;">Location</label>
                    <div class="col-lg-10">
                        {!! Form::text('location', Input::old('location'), array('class' => 'form-control input-sm','placeholder'=>'Location')) !!}
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputName" class="col-lg-2 control-label" style="padding-top: 1%;font-weight: bold;">Secret</label>
                    <div class="col-lg-10">
